...
| 2026-04-21 | INGEST: 5 inbox items — Willison system-prompt-archaeology (simonwillison.net), Chronos knowledge-drift (2604.05096), Context Awareness Gate (2411.16133), LLM-SWE Agents survey (2510.09721), ADR context strategies (2604.03826) | +5 new wiki articles, graph +5 nodes +21 edges (v2.0) | brain-ingest scheduled task |
| 2026-04-21 | INGEST: 8 inbox items — Externalization review (2604.08224), Knowledge Compounding (2604.11243), Missing Knowledge Layer (2604.11364), SemaClaw (2604.11548), ByteRover (2604.01599), Persistent Identity (2604.09588), Process Reward Agents (2604.09482), Corpus2Skill (2604.14572) | +8 new wiki articles, graph +8 nodes +35 edges (v2.1) | brain-ingest scheduled task |
| 2026-04-22 | INGEST: 7 inbox items — Willison headless-services-ai (simonwillison.net), Willison training-data-poisoning (simonwillison.net), ParaManager small-model-orchestrator (2604.17009), Self-Optimizing Deep Research (2604.02988), CoCR-RAG (2603.23989), AgentForge DUPLICATE SKIP (2604.13120 already processed 2026-04-18), Adaptive Orchestration DMoE (2601.09742) | +6 new wiki articles, graph +6 nodes +25 edges (v2.2) | brain-ingest scheduled task |
