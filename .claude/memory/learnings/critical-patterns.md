...
## 10. Evolve/Maintenance: Verify Current State, Don't Trust Own Log
...
verify: manual
last_confirmed: 2026-04-12
- **"Heartbeat-triggered intervention: orchestrátor posílá prompt-injections do běžících agentů (reflect** (promoted from `2026-04-08-heartbeat-mid-run-steering.md`, uses=10, conf=1.0)
- **"CORAL pattern: agents share knowledge via symlinked `.coral/public/` dir instead of message passing** (promoted from `2026-04-08-shared-public-state-agent-coordination.md`, uses=11, conf=1.0)
