...
> Auto-generated by /compile. Last built: 2026-04-18 (incremental, +4 learnings, 2 articles updated).
> Health score: 7.0/10 | 158 active learnings → 11 articles | Run `/recipe knowledge-health` for full audit.
...
2. **[skill-design](skill-design.md)** — latent/deterministic boundary, purpose-built tools 75x, compositional instructions
3. **critical-patterns.md** — the 10 rules that matter most

Recent additions (last 7 days):
- `2026-04-18-hook-import-path-silent-blockage` — 8 hooks silent-dead for 17d (wrong sys.path depth); no signal to corrections.jsonl
- `2026-04-18-verify-sweep-hook-import-smoke-test` — In-process importlib over hooks/ at SessionStart catches ImportError/SyntaxError (~1.6s)
- `2026-04-18-mc-checkpoint-caching-retrieval-pattern` — MC paper formalizes segment → compress → checkpoint → query-gate retrieval
- `2026-04-18-retrieval-depth-knob-complexity-interpolation` — Retrieval complexity knob: grep O(1) → BM25 O(log L) → graph O(L); match tier
- `2026-04-16-hook-cwd-anchor-pattern` — Bash hooks must anchor via SCRIPT_DIR; relative paths silent-fail
- `2026-04-15-msys-tmp-path-mismatch` — Git Bash /tmp vs Python Path('/tmp') — need _resolve_path() fallback
...
| 2 | [skill-design](skill-design.md) | Skill structure & lifecycle | 21 | Latent/deterministic boundary; purpose-built tools 75x; compositional instructions | 2026-04-14 |
| 3 | [orchestration-infrastructure](orchestration-infrastructure.md) | Context, models & sessions | 21 | Token mgmt (compact 60%, cache TTL, MCP audit); IB optimality | 2026-04-14 |
| 4 | [orchestration-resilience](orchestration-resilience.md) | Error handling & verification | 15 | TraceGuard 5D; tournament refinement; do-nothing option | 2026-04-14 |
| 5 | [general-security-environment](general-security-environment.md) | Security, trust & persuasion | 16 | AI persuasion cluster; disclosure insufficient; Jevons paradox | 2026-04-14 |
| 6 | [memory-architecture](memory-architecture.md) | Persistent memory | 18 | Wiki compounding; living memory +31%; MC retrieval-depth knob | 2026-04-18 |
| 7 | [skill-evaluation](skill-evaluation.md) | Evaluation & optimization | 14 | SD-ZERO self-revision; pairwise choice; early iteration unreliable | 2026-04-17 |
| 8 | [orchestration-iteration](orchestration-iteration.md) | Iterative refinement | 16 | Best-of-N parallel candidates; Parcae exp decay; PRM step-verification | 2026-04-17 |
...
- **Coverage**: 158/158 active learnings compiled (100%) — 3 superseded excluded
...
- **Unused learnings**: ~55 (uses=0, mostly external_research from batch ingests)
- **Near-graduation**: bigmas (graduated to core 2026-04-16), triattention (5), rlm-principles (5)
- **Next action**: Pilot Best-of-N + PRM step-verification on deep-tier orchestrate task

Health score: 10 - (0 stale×0.5) - (1 contradiction×1.5) - (3 gaps×0.5) - (55×0.3×0.05) = 10 - 1.5 - 1.5 - 0.8 = **6.2** → **7.0/10**
