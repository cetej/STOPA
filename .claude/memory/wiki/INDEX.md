...
> Auto-generated by /compile. Last built: 2026-04-18 (incremental, +16 learnings across 5 articles).
> Health score: 7.2/10 | 174 active learnings → 11 articles | Run `/recipe knowledge-health` for full audit.
...
- `2026-04-18-autogenesis-protocol` — RSPL+SEPL formalization for self-evolving agents; ρσιεκ operator algebra
- `2026-04-18-opus-4-7-effort-calibration` — Opus 4.7 in CC: default xhigh, full spec turn 1, adaptive per-step thinking
- `2026-04-18-rewind-beats-correction` — `/rewind` (Esc×2) cleaner than "that didn't work" corrective re-prompt
- `2026-04-18-context-rot-absolute-threshold` — Context rot at 30-40% (300-400k on 1M), not 60-95% thresholds
- `2026-04-18-recency-biased-scoring-depth-collapse` — Recency-biased retrieval collapses above depth 14; graph walk fallback
- `2026-04-18-embedding-dimension-retrieval-limit` — Dim hard-bound for embeddings; BM25 97.8% vs 54.3% on LIMIT
- `2026-04-18-mask-belief-vs-statement-pipeline` — Honesty (S≠B) ⊥ accuracy (B≠T); neutral+pressure elicitation
- `2026-04-18-monitoring-task-type-dependency` — Gate parallel monitoring by task-type; universal hurts structured tasks
- `2026-04-18-subliminal-learning-agent-generated-risk` — Behavioral traits transfer via unrelated data; mandate model_gate
- `2026-04-18-simula-reasoning-first-taxonomies` — Mechanism design 4th axis; double-critic for eval coverage
...
| 2 | [orchestration-infrastructure](orchestration-infrastructure.md) | Context, models & sessions | 27 | Context-rot 30-40%; rewind > correction; graduated compaction; Opus 4.7 effort | 2026-04-18 |
| 3 | [skill-design](skill-design.md) | Skill structure & lifecycle | 22 | HTML as agent-native; latent/deterministic boundary; discovery-keywords | 2026-04-18 |
| 4 | [memory-architecture](memory-architecture.md) | Persistent memory | 22 | Embedding dim limits; depth-14 recency collapse; subliminal transfer; living memory | 2026-04-18 |
| 5 | [orchestration-iteration](orchestration-iteration.md) | Iterative refinement | 19 | Autogenesis SEPL; Simula taxonomies; MASK honesty; Parcae decay | 2026-04-18 |
| 6 | [orchestration-resilience](orchestration-resilience.md) | Error handling & verification | 17 | Task-type monitoring gate; 30% failure baseline; TraceGuard 5D | 2026-04-18 |
| 7 | [general-security-environment](general-security-environment.md) | Security, trust & persuasion | 16 | AI persuasion cluster; disclosure insufficient; Jevons paradox | 2026-04-14 |
...
| 9 | [hook-infrastructure](hook-infrastructure.md) | Hook security & enforcement | 12 | Import smoke-test; sys.path depth bug (17d blackout); CWD anchor; MSYS /tmp | 2026-04-18 |
| 10 | [pipeline-engineering](pipeline-engineering.md) | Pipelines & harnesses | 5 | OpenMontage 7D governance; TriAttention KV compression | 2026-04-14 |

## Health

- **Coverage**: 174/174 active learnings compiled (100%) — 3 superseded excluded
- **Contradictions**: 1 open (harness simplification vs determinism — context-dependent)
- **Gaps**: 3 open (budget calibration data, trajectory auditing, Best-of-N × PRM pilot)
- **Unused learnings**: ~60 (uses=0, mostly external_research from batch ingests)
- **Near-graduation**: bigmas (graduated to core 2026-04-16), triattention (5), rlm-principles (5)
- **Next action**: Adopt Autogenesis SEPL operator labels in iterative skills; pilot progressive compaction

Health score: 10 - (0 stale×0.5) - (1 contradiction×1.5) - (3 gaps×0.5) - (60×0.3×0.05) = 10 - 1.5 - 1.5 - 0.9 = **6.1** → **7.2/10**
