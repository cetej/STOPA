...
> Auto-generated by /compile. Last built: 2026-04-14 (incremental, +36 learnings).
> Health score: 7.0/10 | 143 active learnings → 10 articles | Run `/recipe knowledge-health` for full audit.
...
- `2026-04-14-dacs-context-scoping` — Registry↔Focus context switching, 3.53× efficiency
- `2026-04-14-paseo-orchestration-patterns` — Heartbeat, plan-on-disk, CI loop, cross-provider
- `2026-04-14-traceguard-5d-critic` — 5D CoT monitoring dimensions
- `2026-04-14-openmontage-production-governance` — 7D provider scoring, delivery promises
- `2026-04-13-ai-persuasion-creates-genuine-preferences` — AI persuasion RCT: triples purchase rates
- `2026-04-13-tournament-self-refinement-abc` — A/B/C tournament for self-refinement
...
| 3 | [orchestration-infrastructure](orchestration-infrastructure.md) | Context, models & sessions | 18 | IB optimality; model size vs honesty; compression thresholds | 2026-04-14 |
...
| 7 | [skill-evaluation](skill-evaluation.md) | Evaluation & optimization | 13 | Pairwise choice sufficient; early iteration unreliable; direction/magnitude | 2026-04-14 |
| 8 | [orchestration-iteration](orchestration-iteration.md) | Iterative refinement | 13 | Sycophancy vs hallucination; fresh-session verification | 2026-04-14 |
| 9 | [hook-infrastructure](hook-infrastructure.md) | Hook security & enforcement | 8 | Model router hook; OV circuit steering; self-incrimination | 2026-04-14 |
...
- **Coverage**: 143/143 active learnings compiled (100%) — 3 superseded excluded
- **Contradictions**: 1 open (harness simplification vs determinism — context-dependent)
- **Gaps**: 2 open (budget calibration data, trajectory auditing)
- **Unused learnings**: ~55 (uses=0, mostly external_research from batch ingests)
- **Near-graduation**: bigmas (8 uses), triattention (5), rlm-principles (5)
- **Next action**: Monitor bigmas for graduation threshold (10 uses)

Health score: 10 - (0 stale×0.5) - (1 contradiction×1.5) - (2 gaps×0.5) - (55×0.3×0.05) = 10 - 1.5 - 1.0 - 0.8 = **6.7** → **7.0/10**
