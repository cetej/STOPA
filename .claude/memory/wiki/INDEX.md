...
> Auto-generated by /compile. Last built: 2026-04-14 (incremental, +3 learnings).
> Health score: 7.0/10 | 146 active learnings → 10 articles | Run `/recipe knowledge-health` for full audit.
...
- `2026-04-14-mcp-server-token-overhead` — MCP servers ~18K tokens/message invisible overhead
- `2026-04-14-compact-timing-60pct` — Compact at 60%, max 3-4 per session
- `2026-04-14-prompt-cache-ttl-5min` — Cache TTL 5min; pause = full reprocessing
...
- **Coverage**: 146/146 active learnings compiled (100%) — 3 superseded excluded
