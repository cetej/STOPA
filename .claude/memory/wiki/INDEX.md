...
> Auto-generated by /compile. Last built: 2026-04-17 (incremental, +6 learnings, 3 articles regenerated).
> Health score: 7.0/10 | 152 active learnings → 10 articles | Run `/recipe knowledge-health` for full audit.
...
- `2026-04-15-best-of-n-parallel-candidates` — Fork 2-3 candidates, score, expand best (not linear retry)
- `2026-04-15-parcae-exponential-decay-stopping` — L(T)=L∞+Z·exp(-z·T) fits after 4 iters for early-termination
- `2026-04-15-prm-step-verification-orchestrate` — Haiku step-check after each subtask, early-kill on FAIL
- `2026-04-15-sd-zero-self-revision-supervision` — Self-revision turns binary rewards into dense supervision
...
| 6 | [memory-architecture](memory-architecture.md) | Persistent memory | 16 | Wiki compounding; evolve must verify; living memory +31% | 2026-04-14 |
...
| 9 | [hook-infrastructure](hook-infrastructure.md) | Hook security & enforcement | 10 | CWD anchor pattern; MSYS /tmp mismatch; model router hook; OV steering | 2026-04-17 |
...
- **Coverage**: 152/152 active learnings compiled (100%) — 3 superseded excluded
