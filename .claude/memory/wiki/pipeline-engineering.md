...
When bulk mechanical changes touch 30+ files, the Read/Edit tool loop creates approval fatigue — batch Python scripts with --dry-run mode are the practical solution (ref: 2026-03-25-batch-edit-pattern.md).
