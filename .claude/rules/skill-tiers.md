...
| `meta` | Introspekce, evoluce, budget | status, budget, scribe, evolve, compile, discover, skill-generator, radar, watch, liveprompt, xsearch, deepresearch, seo-audit, youtube-transcript, incident-runbook, systematic-debugging, project-sweep |
